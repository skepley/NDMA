"""
An implementation of the two node toggle switch as a Hill model class. Each edge has free (but identical) Hill coefficients,
hill_1 = hill_2 = hill, and possibly some other parameters free. There is always a repressing interaction between both nodes
and additionally, either node may have a self interaction added. This means there are a total of 2-4 edges and up to 17
variable parameters.
...
class ToggleSwitch(HillModel):
    ...
    def bootstrap_enclosure(self, *parameter, tol=1e-13):
        ...
        x0Bounds = H0.image(p0[0]) / g0
        x1Bounds = H1.image(p1[0]) / g1
